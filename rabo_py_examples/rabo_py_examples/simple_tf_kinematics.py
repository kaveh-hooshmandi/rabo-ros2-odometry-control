...
from rabo_msgs.srv import GetTransform
...
class SimpleTfKinematics(Node):
    ...
    def __init__(self):
        ...
        self.static_transform_stamped_.header.frame_id = "rabo_base"
        self.static_transform_stamped_.child_frame_id = "rabo_top"
        ...
        self.timer_= self.create_timer(0.02, self.timerCallback)
    ...
    def timerCallback(self):
        ...
        self.dynamic_transform_stamped_.child_frame_id = "rabo_base"
